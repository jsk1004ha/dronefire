...
def generate():
    ...
    phases = [
        (0.0, 3.0, "1. 화재 감지·이륙", "#94a3b8"),
        (3.0, 15.0, "2. 화원 정밀 접근 (0→1m)", "#38bdf8"),
        (15.0, 19.0, "3. 호버링 & 소화약제 분사", "#ef4444"),
    ...
    for start, end, label, col in phases:
        ...
        ax_gantt.text((start + end)/2, 0, label, ha="center", va="center", color="#ffffff", fontweight="bold", fontsize=9.5)
    ...
    ax_hrr.legend(loc="upper right", framealpha=0.9)
    ...
    ax_pwr.legend(lines1 + lines2, labels1 + labels2, loc="upper right", framealpha=0.9)
